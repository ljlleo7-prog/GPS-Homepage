-- Update play_reaction_game to allow unlimited plays but limit rewards
-- Users can play anytime to improve their score (for leaderboard).
-- But they only get Token rewards if their last REWARDED play was > 60 mins ago.
